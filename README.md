...
Για να τρέξει η εφαρμογή θα πρέπει αρχικά να γίνει εγκατάσταση του ADB στον υπολογιστή. Αυτό μπορεί να γίνει είτε με τον τρόπο που περιγράφεται στη σελίδα του ADB https://developer.android.com/tools/adb, 
είτε μέσω ενός plugin για το Intellij Idea όπως αυτό: https://plugins.jetbrains.com/plugin/7380-adb-idea. Για την εργασία χρησιμοποιήθηκε emulator ως συσκευή Android. Τέλος, θα πρέπει να δοθεί στο adb πρόσβαση root. Αυτο γίνεται με την εντολή: adb root. Η εντολή αυτή λειτουργεί μόνο σε development builds.
