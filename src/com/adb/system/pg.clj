...
(defmethod hugs/hugsql-result-fn :one [sym] 'com.adb.system.pg/result-one->kebab)

(defmethod hugs/hugsql-result-fn :1 [sym] 'com.adb.system.pg/result-one->kebab)

(defmethod hugs/hugsql-result-fn :many [sym] 'com.adb.system.pg/result-many->kebab)

(defmethod hugs/hugsql-result-fn :* [sym] 'com.adb.system.pg/result-many->kebab)
...
(defmethod hugs/hugsql-result-fn :default [sym] 'com.adb.system.pg/result-raw->kebab)

(defmethod hugs/hugsql-result-fn :raw [sym] 'com.adb.system.pg/result-raw->kebab)
