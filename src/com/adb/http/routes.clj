(ns com.adb.http.routes
  (:require [reitit.ring :as ring]
            ...
            [com.adb.http.middleware :as mw]
            [com.adb.mobile.routes :as mobile.routes])
  (:import [java.util Date]))

(defn- session-store-options
  []
  (let [opts {:cookie-name  "adb-session-id"
  ...
  (ring/ring-handler
    (ring/router
      [["/swagger/swagger.json"
        {:get {:no-doc  true
               :swagger {:info {:title       "Sample ADB API"
